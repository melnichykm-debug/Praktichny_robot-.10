...
## Примітка для звітності

До GitHub-репозиторію потрібно додати фінальний скріншот з меню `eu-node-basics-workshop`, де біля вправ 10.1–10.3 видно позначки `[COMPLETED]`.
